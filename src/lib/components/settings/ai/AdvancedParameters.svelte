...
<div class="bg-base-50 rounded-lg p-4">
	...
	<div class="tabs tabs-lift">
		...
		<div class="tab-content bg-base-100 border-base-300 p-6">
			<div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
				<div class="form-control">
					...
					<div class="mt-2 text-xs opacity-60">Steuert die Kreativität der Antworten</div>
				</div>
				...
				<div class="form-control">
					...
					/>
					<div class="mt-2 text-xs opacity-60">Nucleus Sampling - alternative zur Temperature</div>
				</div>
				...
				<div class="form-control">
					...
					/>
					<div class="mt-2 text-xs opacity-60">Reduziert Wiederholungen häufiger Wörter</div>
				</div>
				...
				<div class="form-control lg:col-span-2">
					...
					/>
					<div class="mt-2 text-xs opacity-60">Fördert neue Themen und verhindert Repetition</div>
				</div>
			</div>
		</div>
		...
		<div class="tab-content bg-base-100 border-base-300 p-6">
			<div class="mb-4">
				<h4 class="mb-3 text-base font-medium">Schnell-Einstellungen</h4>
				...
				>
					...
					>
						<path
							stroke-linecap="round"
							stroke-linejoin="round"
							d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.254 48.254 0 0 0 12 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52 2.062 9.571a11.429 11.429 0 0 1-2.062-.52M18.75 4.97l2.062 9.57M6 9.97l3.5 1.963 2-3.896"
						/>
					</svg>
					<div class="text-left">
